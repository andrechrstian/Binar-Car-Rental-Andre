...
const CarDetail = (props) => {
  ...
  function ButtonLP() {
    if (startDate !== null && endDate !== null && token !== null) {
      return (
        <button onClick={handleButtonLP} className="cardetail-result-button">
      ...
      return <button className="cardetail-result-button">pilih tanggal</button>;
    }
  }
  ...
  return (
    <div className="cardetail-section">
      <div className="cardetail-desc-bg">
        ...
        <div className="cardetail-desc">
          <div>
            <p className="cardetail-desc-title-refund-p">
              ...
              <div className="cardetail-result-date-input">
                ...
                <div className="cardetail-result-price-bg">
                  ...
                  <div className="cardetail-result-price-p-bg">
                    <p className="cardetail-result-price-p">
                      Rp <PriceTotal />
                    </p>
                  </div>
                </div>
