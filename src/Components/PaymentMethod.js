        ...
        <div>
          <div className="paymentmethod-paymentdetail-bg">
            <div className="paymentmethod-paymentdetail">
              <div>
                <p className="paymentmethod-paymentdetail-title-p">
                  Detail Pesananmu
                </p>
              </div>
              <div className="paymentmethod-paymentdetail-desc-bg">
                <div className="paymentmethod-paymentdetail-input-bg">
                  <div>
                    <p className="paymentmethod-paymentdetail-desc-title-p">
                      Nama/Tipe Mobil
                    </p>
                  </div>
          ...
          <div className="paymentmethod-bank-pay-bg">
            <div className="paymentmethod-bank">
              <div>
                <p className="paymentmethod-bank-title-p">
                  Pilih Bank Transfer
                </p>
              </div>
              <div className="paymentmethod-bank-desc-bg">
                <p className="paymentmethod-bank-desc-p">
              ...
              <div className="paymentmethod-bank-option-bg">
                <div
                  className="paymentmethod-bank-option"
                  onClick={handleBcaMethode}
                >
                  ...
                  {bca === true ? (
                    <div className="paymentmethod-bank-option-check-bca">
                      <FiCheck
                        size={24}
                        className="paymentmethod-bank-option-check"
                      />
                    </div>
                  ) : null}
                </div>
                ...
                <div
                  className="paymentmethod-bank-option"
                  onClick={handleMandiriMethode}
                >
                  <div className="paymentmethod-bank-option-bank-logo">
                    <p className="paymentmethod-bank-option-bank-p">Mandiri</p>
                  </div>
                  <div className="paymentmethod-bank-option-desc">
                    <p className="paymentmethod-bank-option-p">
                      Mandiri Transfer
                    </p>
                  </div>
                  {mandiri === true ? (
            ...
            <div className="paymentmethod-next">
              <div>
                <div>
                  <p className="paymentmethod-next-carname-p">
                    {order.Car.name}
                  </p>
                </div>
                  ...
                  <Accordion.Item eventKey="0">
                    <Accordion.Header>
                      <div className="paymentmethod-next-accord-title-bg">
                        <div>
                          <p className="paymentmethod-next-accord-total-p">
                            Total
                          </p>
                        </div>
                        <div className="paymentmethod-next-accord-title-price">
                          <p className="paymentmethod-next-accord-title-price-p">
                            Rp. {PriceTotal(order.Car.price)}
                          </p>
                        </div>
                      </div>
                    </Accordion.Header>
                    <Accordion.Body>
                      <div className="paymentmethod-next-accord-body">
                        <div>
                          <div>
                            <p className="paymentmethod-next-accord-body-price-title-p">
                              Harga
                            </p>
                          </div>
                          <div className="paymentmethod-next-accord-body-price-desc">
                            <div>
                              <ul>
                                <li className="paymentmethod-next-accord-body-price-li">
                                  Sewa Mobil Rp.{order.Car.price} x {dateCount}{" "}
                                  Hari
                                </li>
                              </ul>
                            </div>
                            <div>
                              <p className="paymentmethod-next-accord-body-price-p">
                                Rp. {PriceTotal(order.Car.price)}
                              </p>
                            </div>
                          </div>
                        ...
                        <div className="paymentmethod-next-accord-body-anotherbill">
                          <div>
                            <p className="paymentmethod-next-accord-body-anotherbill-title-p">
                              Biaya Lainnya
                            </p>
                          </div>
                          <div className="paymentmethod-next-accord-body-anotherbill-desc">
                            <div>
                              <ul>
                                <li className="paymentmethod-next-accord-body-anotherbill-li">
                                  Pajak
                                </li>
                              </ul>
                            </div>
                            <div>
                              <p className="paymentmethod-next-accord-body-anotherbill-p">
                                Termasuk
                              </p>
                            </div>
                          </div>
                        ...
                        <div className="paymentmethod-next-accord-body-exclude">
                          <div>
                            <p className="paymentmethod-next-accord-body-exclude-title-p">
                              Belum Termasuk
                            </p>
                          </div>
                          <div className="paymentmethod-next-accord-body-exclude-desc">
                            <ul>
                              <li className="paymentmethod-next-accord-body-exclude-li">
                                Bensin
                              </li>
                            </ul>
                          </div>
                        ...
                        <div className="paymentmethod-next-accord-total-bottom">
                          <div>
                            <p className="paymentmethod-next-accord-total-bottom-p">
                              Total
                            </p>
                          </div>
                          <div>
                          ...
                          if (
                            ...
                            return (
                              <div className="paymentmethod-next-accord-button-bg">
                                ...
                                >
                                  <button className="paymentmethod-next-accord-button">
                                    Bayar
                                  </button>
                                </Link>
                              </div>
                            ...
                            return (
                              <div className="paymentmethod-next-accord-button-bg">
                                <button className="paymentmethod-next-accord-button-disable">
                                  Bayar
                                </button>
                              </div>
                            );
